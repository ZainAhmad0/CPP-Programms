...
{
    vertex* vIterator1;
    for(vIterator1 = head; vIterator1->vertexValue != vertexValue1; vIterator1 = vIterator1->next); //traverses downward to find vertexValue1
    ...
    vertex* vIterator2;
    for(vIterator2 = head; vIterator2->vertexValue != vertexValue2; vIterator2 = vIterator2->next); //traverses downward to find vertexValue2
